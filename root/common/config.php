...
$M_SURAT["2"]["template"]["edit"]   = "surat_bpjs.edit.php";
$M_SURAT["2"]["template"]["print"]  = "surat_bpjs.print.php";
$M_SURAT["2"]["template"]["cetak"]  = "surat_bpjs.cetak.php";
$M_SURAT["2"]["template"]["cetak1"] = "surat_bpjs.cetak1.php";
$M_SURAT["2"]["template"]["cetak2"] = "surat_bpjs.cetak2.php";
...
$M_SURAT["3"]["template"]["edit"]   = "surat_kjp.edit.php";
$M_SURAT["3"]["template"]["print"]  = "surat_kjp.print.php";
$M_SURAT["3"]["template"]["cetak"]  = "surat_kjp.cetak.php";
$M_SURAT["3"]["template"]["cetak1"]  = "surat_kjp.cetak1.php";
$M_SURAT["3"]["template"]["cetak2"]  = "surat_kjp.cetak2.php";
...
$M_SURAT["4"]["template"]["edit"]   = "surat_skck.edit.php";
$M_SURAT["4"]["template"]["print"]  = "surat_skck.print.php";
$M_SURAT["4"]["template"]["cetak"]  = "surat_skck.cetak.php";
$M_SURAT["4"]["template"]["cetak1"]  = "surat_skck.cetak1.php";
$M_SURAT["4"]["template"]["cetak2"]  = "surat_skck.cetak2.php";
