...
require ("fpdf17/fpdf.php");
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN SURAT BPJS','TBLR',0,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
    ...
    $pdf->Cell(4,1,'NOMOR SURAT','LRTB',0,'C');
    $pdf->Cell(5,1,'TANGGAL PEMBUATAN','LRTB',0,'C');
    //$pdf->Cell(6,1,'NO KTP','LRTB',0,'C');
    $pdf->Cell(7,1,'NAMA PEMBUAT','LRTB',0,'C');
