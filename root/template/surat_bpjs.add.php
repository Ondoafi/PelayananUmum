...
<script type="text/javascript" src="javascript/surat_bpjs.add.js"></script>

<form id="form1" class="form-horizontal" method="post" action="index.php?form=C.02">
    ...
    <table border="0" cellspacing="0" width="100%">
        ...
        <div class="control-group">											
            <label class="control-label" for="kelamin"></label>
                ...
                <input type="text" class="span3" id="kelamin" name="kelamin"  value="<?php echo htmlentities($kelamin); ?>"/>
                -&nbsp;<input type="text" class="span3" id="agama" name="agama"  value="<?php echo htmlentities($agama); ?>"/>
                -&nbsp;<input type="text" class="span3" id="pekerjaan" name="pekerjaan"  value="<?php echo htmlentities($pekerjaan); ?>"/>
                <br />
                <br />
