...
<script type="text/javascript" src="javascript/surat_skck.edit.js"></script>
<form id="form2" class="form-horizontal" method="post" action="index.php?form=D.02&id=<?php echo $suratskck->id; ?>">
...
<td style="padding: 5px 5px 5px 5px"><div align="right">
    <input class="btn btn-invert" type="button" name="batal" id="batal" value="&laquo; BATAL" onclick="window.location = 'index.php?form=D.04'"/>
