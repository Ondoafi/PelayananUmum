...
<script type="text/javascript" src="javascript/scriptaculous/scriptaculous.js"></script>
    ...
    <p class='pull-left'>
       ...
       <a href='index.php?form=E.03&print=true&id=<?php echo $id;?>'
          target='_blank'
          class="btn" ><i class='icon-print'></i>&nbsp;Format A </a>
       
       <a href='index.php?form=E.03&cetak=true&id=<?php echo $id;?>'
          target='_blank'
          class="btn" ><i class='icon-print'></i>&nbsp;Format B </a>   
          
       <a href='index.php?form=E.03&cetak1=true&id=<?php echo $id;?>'
          target='_blank'
          class="btn" ><i class='icon-print'></i>&nbsp;Format C</a>
          
       <a href='index.php?form=E.03&cetak2=true&id=<?php echo $id;?>'
          target='_blank'
...
<table cellspacing="0" border="0" id="tech-companies-1" class="table table-small-font table-bordered table-striped">
   ...
   <tr>
    ...
    <tr>
        ...
        <td style="padding: 2px" align="justify"> Bahwa nama tersebut diatas berdasarkan pengantar 
        RT/RW setempat adalah warga kami yang keadaannya tidak mampu. Surat Keterangan ini
        diperlukan untuk Mengurus Kartu Jakarta Pintar (KJP) Anaknya yang bernama&nbsp;<?php echo $content['anak'] ;?>&nbsp;di&nbsp;<?php echo $content['sekolah'];?>
    </tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <td style="padding: 2px">&nbsp;<?php echo $content['anak']; ?></td>
      </tr>
      
      <tr>
        <td><strong>Sekolah</strong></td>
        <td style="padding: 2px">&nbsp;<?php echo $content['sekolah']; ?></td>
      </tr>
    ...
    <tr>
        ...
        <td style="padding: 5px 5px 5px 5px"><div align="left">
            <input class="btn btn-invert" type="button" name="back" id="back" value="&laquo; BATAL" onclick="window.location = 'index.php?form=E.04'"/></td>
            <input class="btn btn-invert" type="button" name="edit" id="edit" value="&laquo; EDIT &raquo;" onclick="window.location = 'index.php?form=E.05&id=<?php echo $suratkjpId; ?>'"/></td>
          ...
          var hapus = $('hapus');
					hapus.observe('click', function(){
							if(confirm('Anda yakin akan menghapus Surat KJP: <?php echo htmlentities($suratkjp->noSurat); ?>, Yang dibuat oleh <?php echo $content["alias"]; ?>'))
									window.location = 'index.php?form=E.03&id=<?php echo $suratkjp->id; ?>&delete=true';
					});
          </script>
