...
<script type="text/javascript" src="javascript/surat_bpjs.edit.js"></script>

<form id="form2" class="form-horizontal" method="post" action="index.php?form=C.02&id=<?php echo $suratbpjs->id; ?>">
  ...
  <div class="form-region">
    ...
    <br />
    <samp>Format Yang Diinputkan/Diketikan:</samp>
    <br />
    <pre>
    Anaknya Yang Bernama
    Ibu dan 2 Orang anak (Sesuaikan Jumlah Anak)
    1(Satu) Keluarga
    Dengan pemohon Kepala Keluarga, Istri dan 1 orang Anak (Sesuaikan Jumlah Anak) </pre>
    </div> <!-- /controls --></div> <!-- /control-group -->
    <br />
    
     <div class="control-group">											
    <label class="control-label" for="namapemohon">*NAMA ANAK</label>
    <div class="controls">
        <input type="text" class="span6" id="namapemohon" name="namapemohon" value="<?php echo $content['namapemohon']; ?>"/>
     <br />
    <samp>Keterangan : </samp>
    <br />
    <pre>
     Nama Anak Hanya Diisi Apabila Anda Menginputkan Format Anaknya Yang Bernama, 
     Pada Form *PERMOHONAN, Jika anda Menginputkan Format Lain Biarkan Kosong</pre>
    </div> <!-- /controls --></div> <!-- /control-group -->
        <br /><hr style="color:yellow"/>
    </div>
        </div>
        ...
        <div class="control-group">											
		  ...
		  <div class="controls">
		<input type="text" class="span6" id="alias" name="alias" value="<?php echo $content["alias"]; ?> Diedit Oleh <?php echo $_SESSION["root"]["nama"]; ?> "readonly=""/>
		</div> <!-- /controls --></div> <!-- /control-group -->
...
<td style="padding: 5px 5px 5px 5px"><div align="left">
    <input class="btn btn-invert" type="button" name="batal" id="batal" value="&laquo; BATAL" onclick="window.location = 'index.php?form=C.04'"/>
