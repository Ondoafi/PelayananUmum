...
<div class="form-region">
        ...
        <tr>
            ...
            <td style="padding: 2px"><input type="text" id="username" name="username" value="<?php echo htmlentities($username) ?>"style="width: 250px" readonly=""/></td>
        </tr>
        
        <tr>
            <td><strong>Password</strong></td>
            <td style="padding: 2px"><input type="text" id="password" name="password" value="<?php echo htmlentities($password) ?>" style="width: 250px" readonly=""/></td>
        </tr>
        ...
        <tr>
          ...
          <tr>
            ...
            <input class="btn btn-invert" type="button" name="back" id="back" value="&laquo; BATAL" onclick="window.location = 'index.php?form=B.03&id=<?php echo $penduduk->id; ?>'"/></td>
