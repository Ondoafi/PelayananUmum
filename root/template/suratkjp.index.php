...
<div class="shortcuts"> 
<form id="form1" method="post" action="index.php?form=E.04">
...
<tr>
    ...
    <tr>
        ...
        <td><?php echo $result["content"][$i]["pemohon"]; ?> <?php echo $result ["content"][$i]["anak"];?></td>
        <td>
            <a href="index.php?form=E.03&id=<?php echo $result["content"][$i]["id"];?>" class="icon-large icon-zoom-in">Detail&nbsp; 
        </td>
    </tr>
        <?php endfor ?>
    </table>
