...
function up_4205_5000($_prefix,$_link)
{
    ...
    $commands[] = array(0,"UPDATE `".DBManager::RealEscape($_prefix)."tickets` SET `iso_language`='".DBManager::RealEscape(strtoupper($CONFIG["gl_default_language"]))."' WHERE `iso_language`='';");
