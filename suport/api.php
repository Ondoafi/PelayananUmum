...
class LiveZillaAPI
{
	...
	{
		queryDB(true,"DELETE FROM `".DB_PREFIX.DATABASE_OPERATORS."` WHERE `id`='".DBManager::RealEscape($_loginId)."' LIMIT 1;");
		queryDB(true,"DELETE FROM `".DB_PREFIX.DATABASE_PREDEFINED."` WHERE `internal_id`='".DBManager::RealEscape($_groupId)."';");
	}
