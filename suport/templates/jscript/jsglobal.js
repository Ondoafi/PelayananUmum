...
{	
	...
	{
		var data = this.DelimiterStart + lz_global_base64_url_encode(this.BrowserId + ";" + this.UserId + ";" + this.GeoResolved  + ";" + this.GeoResolutions+ ";" + this.ServerId + ";"+ this.OVLCPos + ";"+ this.OVLCState + ";" + this.OVLCSound + ";" + this.OVLCWM + ";" + this.ECH + ";" + this.TransFrom + ";"+ this.TransInto + ";"+ this.TransSID + ";"+ this.Transcript + ";") + this.DelimiterEnd;
...
function lz_group(_id,_amount,_description,_email,_document,_cihidden,_cimandatory,_tihidden,_timandatory,_cinf,_cmbinf,_tinf,_com)
{
    ...
    function lz_group_create_option()
    {
        try
        {
            ...
            if(this.Amount == 0)
            {
                this.Option.style.color = "#5d5d5d";
                if(this.StatusIcon)
                    this.Option.style.background = "#f7f7f7 url(./images/lz_status_offline.png) no-repeat right 24px top 5px";
                else
            ...
            {
                if(this.StatusIcon)
                    this.Option.style.background = "#FFFFFF url(./images/lz_status_online.png) no-repeat right 24px top 5px";
                else
