...
function lz_chat_message(_translation,_original) 
{
	...
	{
		var sendmsg = true;
		if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_translation_service_active').checked && _original=='' && isNaN(msg))
		{
			...
			var transfrom = lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_translation_target_language').options[lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_translation_target_language').selectedIndex].value;
			...
			if(!sendmsg)
			{
				...
				window.doneTranslateCallback = function translateText(response){if(response.data!=null){lz_chat_message(response.data.translations[0].translatedText,msg);window.doneTranslateCallback=null;}else{lz_chat_chat_alert("Sorry, there was an error while trying to translate:<br><br>" + JSON.stringify(response),lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',''),null);lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_translation_service_active').checked=false;lz_chat_message("",msg);}}
...
function lz_chat_chat_alert_set_position(_frame)
{
	...
	_frame.document.getElementById('lz_chat_alert_box').style.top = "50%";
	_frame.document.getElementById('lz_chat_alert_box').style.left = "50%";
    _frame.document.getElementById('lz_chat_alert_box').style.marginTop = "-"+(_frame.document.getElementById('lz_chat_alert_box').offsetHeight / 2) + "px";
    _frame.document.getElementById('lz_chat_alert_box').style.marginLeft = "-"+(_frame.document.getElementById('lz_chat_alert_box').offsetWidth / 2) + "px";
}
...
function lz_chat_call_back_info(_html)
{
    ...
    lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_call_me_back_wa').innerHTML = '';
}
...
function lz_chat_set_host(_id,_fullname,_groupname,_language,_typing,_vcard,_dygroup)
{
	if(_id.length > 0)
	{
		...
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_operator_typing_info').innerHTML = lz_chat_data.Language.RepresentativeIsTyping.replace("<!--operator_name-->",lz_chat_data.InternalUser.Fullname);
	}
	...
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_subline').style.display = (_id.length > 0 && _typing) ? "" : "none";
	frames['lz_chat_frame.1.1'].document.getElementById('lz_chat_vcard_box').style.display = (_id.length > 0 && _vcard) ? "" : "none";
    frames['lz_chat_frame.1.1'].document.getElementById('lz_chat_logo').style.visibility = (lz_small && _id.length > 0 && lz_chat_data.ShowOperatorInfoBox) ? "hidden" : "visible";
    frames['lz_chat_frame.1.1'].document.getElementById('lz_chat_top_bg').style.visibility = (!lz_small && (_id.length == 0 || !lz_chat_data.ShowOperatorInfoBox)) ? "visible" : "hidden";
	frames['lz_chat_frame.1.1'].document.getElementById('lz_chat_representative').style.visibility = (_id.length > 0 && lz_chat_data.ShowOperatorInfoBox) ? "visible" : "hidden";
}
...
{	
	...
	lz_chat_data.ExternalUser.PreMessage = lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_text').value;
...
{
    lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_main').scrollTop = lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_main').scrollHeight;
}

function lz_chat_print() 
{
    lz_chat_switch_dropdown("",true);
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','').focus();
...
function lz_chat_update_com_chat_data(_timer)
{
	...
	if(lz_chat_data.ComChatVoucherActive.ChatTimeMax > 0)
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_value').innerHTML = lz_format_time_span(lz_chat_data.ComChatVoucherActive.ChatTimeMax - lz_chat_data.ComChatVoucherActive.ChatTime);
	else
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_value').innerHTML = lz_format_time_span(lz_chat_data.ComChatVoucherActive.ChatTime);
	
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_amount_value').innerHTML = lz_chat_data.ComChatVoucherActive.ChatSessions + ((lz_chat_data.ComChatVoucherActive.ChatSessionsMax == -1) ? "" : " / " + lz_chat_data.ComChatVoucherActive.ChatSessionsMax);
	
	var date = new Date(lz_chat_data.ComChatVoucherActive.Expires*1000);
	
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_period_value').innerHTML = date.toLocaleDateString();
	...
	if(lz_chat_data.ComChatVoucherActive.ChatSessionsMax > -1 && lz_chat_data.ComChatVoucherActive.ChatSessionsMax <= lz_chat_data.ComChatVoucherActive.ChatSessions)
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_amount_value').className = 'lz_chat_com_chat_panel_value_over';
	else
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_amount_value').className = 'lz_chat_com_chat_panel_value';
	...
	if(lz_chat_data.ComChatVoucherActive.ChatTime >= lz_chat_data.ComChatVoucherActive.ChatTimeMax && lz_chat_data.ComChatVoucherActive.ChatTimeMax > -1)
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_value').className = 'lz_chat_com_chat_panel_value_over';
	else
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_value').className = 'lz_chat_com_chat_panel_value';
		
	if(lz_chat_data.ComChatVoucherActive.Expired)
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_period_value').className = 'lz_chat_com_chat_panel_value_over';
	else
		lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_period_value').className = 'lz_chat_com_chat_panel_value';
		
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_amount_value').style.display =
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_amount_caption').style.display = (lz_chat_data.ComChatVoucherActive.ChatSessionsMax > -1) ? "" : "none";
		
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_value').style.display =
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_caption').style.display = (lz_chat_data.ComChatVoucherActive.ChatTimeMax > -1) ? "" : "none";
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_length_spacer').style.display = (lz_chat_data.ComChatVoucherActive.ChatSessionsMax > -1 && lz_chat_data.ComChatVoucherActive.ChatTimeMax > -1) ? "" : "none";

	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_period_spacer').style.display = (lz_chat_data.ComChatVoucherActive.Expires > 0 && (lz_chat_data.ComChatVoucherActive.ChatSessionsMax > -1 || lz_chat_data.ComChatVoucherActive.ChatTimeMax > -1)) ? "" : "none";
	...
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_voucher_id').style.display = (lz_chat_data.ComChatVoucherActive.Expires == -1 && lz_chat_data.ComChatVoucherActive.ChatSessionsMax == -1 && lz_chat_data.ComChatVoucherActive.ChatTimeMax == -1) ? "" : "none";
	lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0','lz_chat_com_chat_chat_voucher_id').innerHTML = lz_chat_data.ComChatVoucherActive.Id;
}
...
{	
	...
	{
		var buttons = {sm:"SM",so:"SO",pr:"PR",ra:"RA",fu:"FU",tr:"TR",et:"ET"};
